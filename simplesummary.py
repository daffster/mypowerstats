...
# Get these values from the request to
# https://www.myeskom.co.za/pages/Dashboard/24
data = dict(authKey="repl4c3m3w1ths0m3th1ngl3g1t000", city="xxx")

headers = {
    'Content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
    'Origin': 'https://www.myeskom.co.za',
    'Referer': 'https://www.myeskom.co.za/'}

# The timestamp should be GMT+2. So if you're running from outside of
# South Africa, you may need to adjust this
timestamp = str(int(time.time() * 1000))
resp, content = h.request(
    "https://www.myeskom.co.za/pages/Dashboard/24?v=" + timestamp,
...
print "Power Status:    %s/%s/%s" % (
    powerinfo['level'],
    powerinfo['levelstatus'],
    powerinfo['status'],)
try:
